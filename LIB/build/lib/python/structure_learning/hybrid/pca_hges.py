...
def pca_hges(data, nodes, alpha=0.1, blacklist=False, verbose=False, max_process=5, method=pca, score=bdeu_score):
    """Performs PCA_HGES on the data set and returns the learned DAG
     D3HGES is a three stage algorithm where the first stage is dependency learning,
     second stage is the data-driven discretization using PCA
    ...
    Args:
        ...
        method: discretization to be used in data-driven discretization
